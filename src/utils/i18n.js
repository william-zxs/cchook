...
const messages = {
  'zh-CN': {
    ...
    // Setup command
    'setup.description': '初始化或更新 Claude Code hooks 配置',
    'setup.force': '强制覆盖已有配置',
  ...
  'en-US': {
    ...
    // Setup command  
    'setup.description': 'Initialize or update Claude Code hooks configuration',
    'setup.force': 'Force overwrite existing configuration',
