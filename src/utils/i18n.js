...
const messages = {
  'zh-CN': {
    ...
    'notify.success': '✅ {0} 通知发送成功',
    'notify.failed': '❌ {0} 通知发送失败: {1}',
    'notify.error': '错误: {0}',
    ...
    'config.dingtalk.saved': '✅ 钉钉配置已保存到 ~/.cchook/config.json',
    'config.dingtalk.failed': '❌ 配置钉钉失败: {0}',
    'config.macos.description': '配置 macOS 系统通知',
    'config.macos.title': '通知标题',
    'config.macos.subtitle': '通知副标题',
    'config.macos.sound': '是否播放声音',
    'config.macos.saved': '✅ macOS 通知配置已保存',
    'config.macos.failed': '❌ 配置 macOS 通知失败: {0}',
    'config.show.description': '显示当前配置',
    'config.show.title': '📋 当前配置:',
    'config.show.separator': '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
    'config.show.dingtalk.title': '🔔 钉钉机器人配置:',
    'config.show.dingtalk.token': '  Access Token: {0}',
    'config.show.dingtalk.secret': '  Secret: {0}',
    'config.show.dingtalk.configured': '已设置',
    'config.show.dingtalk.not.configured': '❌ 未设置',
    'config.show.macos.title': '🍎 macOS 通知配置:',
    ...
    'config.show.default.types.title': '🎯 默认通知类型:',
    'config.show.other.title': '⚙️  其他配置:',
    'config.show.mode': '  模式: {0}',
    'config.show.enabled.events': '  启用事件: {0}',
    'config.show.notification.type': '  通知类型: {0}',
    'config.show.failed': '❌ 显示配置失败: {0}',
    'config.reset.description': '重置配置到默认值',
    'config.reset.confirm': '确认重置（必需）',
    'config.reset.warning': '⚠️  此操作将重置所有配置到默认值',
    'config.reset.instruction': '如需确认，请使用: cchook config reset --confirm',
    'config.reset.success': '✅ 配置已重置到默认值',
    'config.reset.failed': '❌ 重置配置失败: {0}',
    'config.types.description': '设置默认通知类型',
    'config.types.set': '通知类型，多个用逗号分隔 (dingtalk,macos)',
    'config.types.success': '✅ 默认通知类型已设置为: {0}',
    'config.types.failed': '❌ 设置默认通知类型失败: {0}',
    'config.list.types.description': '列出所有可用的通知类型',
    'config.list.types.title': '📋 可用的通知类型:',
    'config.list.types.dingtalk': '🔔 dingtalk  - 钉钉机器人通知',
    'config.list.types.macos': '🍎 macos     - macOS 系统通知',
    'config.list.types.usage.title': '💡 使用方法:',
  ...
  'en-US': {
    ...
    'notify.success': '✅ {0} notification sent successfully',
    'notify.failed': '❌ {0} notification failed: {1}',
    ...
    'config.dingtalk.saved': '✅ DingTalk configuration saved to ~/.cchook/config.json',
    'config.dingtalk.failed': '❌ Failed to configure DingTalk: {0}',
    ...
    'config.macos.saved': '✅ macOS notification configuration saved',
    'config.macos.failed': '❌ Failed to configure macOS notifications: {0}',
    'config.show.description': 'Show current configuration',
    'config.show.title': '📋 Current Configuration:',
    'config.show.separator': '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
    'config.show.dingtalk.title': '🔔 DingTalk Robot Configuration:',
    'config.show.dingtalk.token': '  Access Token: {0}',
    'config.show.dingtalk.secret': '  Secret: {0}',
    'config.show.dingtalk.configured': 'Configured',
    'config.show.dingtalk.not.configured': '❌ Not configured',
    'config.show.macos.title': '🍎 macOS Notification Configuration:',
    ...
    'config.show.default.types.title': '🎯 Default Notification Types:',
    'config.show.other.title': '⚙️  Other Configuration:',
    'config.show.mode': '  Mode: {0}',
    'config.show.enabled.events': '  Enabled Events: {0}',
    'config.show.notification.type': '  Notification Type: {0}',
    'config.show.failed': '❌ Failed to show configuration: {0}',
    'config.reset.description': 'Reset configuration to default values',
    'config.reset.confirm': 'Confirm reset (required)',
    'config.reset.warning': '⚠️  This operation will reset all configuration to default values',
    'config.reset.instruction': 'To confirm, use: cchook config reset --confirm',
    'config.reset.success': '✅ Configuration reset to default values',
    'config.reset.failed': '❌ Failed to reset configuration: {0}',
    ...
    'config.types.success': '✅ Default notification types set to: {0}',
    'config.types.failed': '❌ Failed to set default notification types: {0}',
    'config.list.types.description': 'List all available notification types',
    'config.list.types.title': '📋 Available Notification Types:',
    'config.list.types.dingtalk': '🔔 dingtalk  - DingTalk robot notifications',
    'config.list.types.macos': '🍎 macos     - macOS system notifications',
    'config.list.types.usage.title': '💡 Usage:',
