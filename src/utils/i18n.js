...
const messages = {
  'zh-CN': {
    ...
    'status.suggestion.enable': '[TIP] 建议操作: 运行 `cchook config events add Notification` 启用基本通知',
    ...
    'setup.next.test': '• 运行 `cchook config test` 测试通知功能',
    ...
    'test.enable.events': '运行 `cchook config events add Notification` 启用基本通知',
  ...
  'en-US': {
    ...
    'status.suggestion.enable': '[TIP] Suggestion: Run `cchook config events add Notification` to enable basic notifications',
    ...
    'setup.next.test': '• Run `cchook config test` to test notification functionality',
